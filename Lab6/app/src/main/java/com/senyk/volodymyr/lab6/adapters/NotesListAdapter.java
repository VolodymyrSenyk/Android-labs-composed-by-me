package com.senyk.volodymyr.lab6.adapters;
...
public class NotesListAdapter extends RecyclerView.Adapter {
    private Navigation clickListener;
    private List<NotePojo> items = new ArrayList<>();

    public NotesListAdapter(Navigation navigation) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clickListener.onNoteClicked(item.getDateOfLastEditing());
            }
        });
    }
